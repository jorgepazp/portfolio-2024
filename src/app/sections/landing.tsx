...
const LandingPage = () =>{
    ...
    <div className="pointer-events-none z-50 flex flex-1 w-full justify-center relative h-full  p-4 md:pr-96 ">
        <div className=" max-w-full md:max-w-xl relative flex flex-col justify-end md:justify-center">
            ...
            <span className="flex">Hey!</span>
            <p className="leading-tight text-4xl">I'm Jorge but some call me jürgen</p>
        ...
        <div className="mt-5 z-30 mr-5  w-full h-full absolute">
